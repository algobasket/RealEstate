 ...
 <ul class="nav nav-tabs card-header-tabs">
    ...
    <li class="nav-item">
       <a class="nav-link <?= isTabActive("reviews",2);?>" href="<?= base_url();?>/dashboard/reviews">
         Reviews <span class="badge badge-danger">9</span>
          <span class="sr-only">unread messages</span> 
        </a>   
    </li>
    <li class="nav-item">
