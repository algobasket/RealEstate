    ...
    <div class="col-md-9"> 
       ...
       <?php }elseif($section =="edit"){ ?>
        ...
        <div class="container">  
                 ...
                 <div class="col-md-3">
                  ...
                  <?php } ?>
                   ...
                   <div class="col-md-6" style="margin-top: 30px;">
                        <?= form_open('backend/user/customers/edit/'.segment(5),'accept-charset="utf-8" enctype="multipart/form-data"') ?>
             ...
             <?= form_open('backend/user/customers/edit/'.segment(5)) ?>
       ...
       <?php }else{ ?>
        ...
        <div class="table-responsive">
          <table class="table small">
              <caption>List of Buyers & Owners</caption> 
              <thead>
                <tr>
                  <th scope="col">#</th> 
                ...
                <tr style="line-height: 57px">
                  ...
                  <td>
                    <?php if($customer['profile_pic']){ ?>
                       <img src="<?= publicFolder().'/user-images/thumbnails/'.$customer['profile_pic'];?>" class="shadow-lg mx-auto d-block rounded" width="100"/>
                    <?php }else{ ?>
                       <img src="<?= publicFolder().'/images/customer-2.png';?>" class="shadow-lg mx-auto d-block rounded" width="100"/>
                    <?php } ?>
                    
                  </td>
                  <td><?= $customer['firstname'] ? $customer['firstname'].' '.$customer['lastname'] : 'No Name';?></td>
                  <td><?= $customer['email'];?></td>
                  <td><?= $customer['mobile'];?></td>
                  <td><?= strtoupper(str_replace('_',' | ', $customer['activity']));?></td>
