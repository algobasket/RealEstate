    ...
    <div class="col-md-9">
        ...
        <div class="container-fluid emp-profile">
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="<?= base_url();?>/backend/user/agents/edit/<?= $profile['user_id'];?>" class="profile-edit-btn" name="btnAddMore">Edit Profile</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
       ...
       <?php }elseif($section =="edit"){ ?>
         ...
         <div class="container">  
                 ...
                 <div class="col-md-3">
                  ...
                  <?php } ?>
                   ...
                   <div class="col-md-6" style="margin-top: 30px;">
                        <?= form_open('backend/user/agents/edit/'.segment(5),'accept-charset="utf-8" enctype="multipart/form-data"') ?>
             ...
             <?= form_open('backend/user/agents/edit/'.segment(5)) ?>
             <?php //foreach ($profile as $info){} ?>
              ...
              <h4 class="mb-3">RE License Number</h4>

              <div class="row">
                <div class="col-md-5 mb-3">
                  <label for="english_level" class="text-danger">(Required)</label>
                  <input type="text" class="form-control" id="re_license_no" name="re_license_no" value="<?= $profile['re_license_no'] ? $profile['re_license_no'] : "" ;?>" placeholder="Please your valid RE License Number" required />
                  <div class="invalid-feedback">
                    Please enter your RE License Number.
                  </div>
                </div>
              </div>
              ...
              <h4 class="mb-3">Service Area | <a href="javascript:void(0)" class="btn btn-danger btn-sm addServiceAreaBtn">Add Service</a></h4>
               <div class="row addServiceAreaDiv">
                <?php
                 $service_area = json_decode($profile['service_area'],true);
                foreach($service_area as $count =>$sp){ ?>
                   <div class="col-md-5 mb-3">
                      <label for="service_area">Service Area - <?= $count+1;?></label>
                      <input type="text" class="form-control" id="service_area" name="service_area[]" value="<?= $sp;?>" placeholder="Eg : West Pitampura">
                      <div class="invalid-feedback"> 
                ...
                <tr style="line-height: 57px">
                  ...
                  <td>
                     <?php if($agent['profile_pic']){ ?> 
                          <img src="<?= publicFolder();?>/user-images/thumbnails/<?= $agent['profile_pic'];?>" class="shadow-lg mx-auto d-block rounded" width="100"/>
                     <?php }else{ ?>
                          <img src="<?= publicFolder();?>/images/agent-c.png" class="shadow-lg mx-auto d-block rounded" width="100"/> 
                     <?php } ?>
                  </td>
                  <td><?= $agent['firstname'].' '.$agent['lastname'];?></td>
                  <td><?= $agent['email'];?></td>
                  <td><?= $agent['mobile'];?></td>
                  <td><?= totalUserReviews('seller',23,NULL);?></td>  
                  <td><?= totalPropertiesSoldByUser($agent['user_id']);?></td>
                  <td>Rating</td>
                  ...
                  <td>
                     ...
                     <a href="<?= base_url();?>/backend/user/agents/edit/<?= $agent['user_id'];?>">
                      <img src="<?= publicFolder();?>/images/edit.png"  width="20"/> 
                    </a>  |   
                    <a href="javascript:void(0)" data-confirmedUrl="<?= base_url();?>/backend/user/agents/delete/<?= $agent['user_id'];?>" class="deletePop" />  
